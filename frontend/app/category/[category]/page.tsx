...
import { CategoryHero, CategoryPageWrapper, CategoryArticlesGrid } from "@/components/category";
...
const categoryConfig: Record<ArticleCategory, {
    ...
    nourishment: {
        label: "Nourishment",
        description: "Feed your body right. Discover the foods, nutrients, and eating habits that support longevity and vibrant health at every age.",
    ...
    restoration: {
        label: "Restoration",
        description: "Rest, recover, renew. Explore the science of sleep, relaxation, and recovery practices that help your body heal and thrive.",
        color: "text-blue-600",
        bgColor: "bg-blue-600",
        lightBg: "bg-blue-50",
    ...
    mindset: {
        label: "Mindset",
        description: "Your mind matters. Learn powerful mental strategies, mindfulness techniques, and cognitive exercises to stay sharp and positive.",
    ...
    relationships: {
        label: "Relationships",
        description: "Connection is key. Strengthen your bonds with family, friends, and community for a happier, healthier, and longer life.",
        color: "text-rose-600",
        bgColor: "bg-rose-600",
        lightBg: "bg-rose-50",
    ...
    vitality: {
        label: "Vitality",
        description: "Move with purpose. Find the exercise routines, movement practices, and energy-boosting habits that keep you active and alive.",
...
const validCategories: ArticleCategory[] = ["nourishment", "restoration", "mindset", "relationships", "vitality"];

// Mock articles data - replace with API calls later
...
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
    ...
    if (!validCategories.includes(category as ArticleCategory)) {
        return {
            title: "Category Not Found | Total Life Daily",
        };
    }
    ...
    return {
        title: `${config.label} | Total Life Daily`,
...
export default async function CategoryPage({ params }: CategoryPageProps): Promise<JSX.Element> {
    ...
    return (
        <CategoryPageWrapper>
            ...
            {/* Articles Grid */}
            <CategoryArticlesGrid articles={articles} config={config}/>
